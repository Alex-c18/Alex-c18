...
Понимаю концепции **ACID** в базах данных и **IaC**.  
...
| **🗄️ Базы данных** | PostgreSQL, понимание ACID |
| **⚙️ DevOps практики** | IaC, CI/CD, мониторинг, Git |
...
![Terraform](https://img.shields.io/badge/Terraform-7B42BC?style=for-the-badge&logo=terraform&logoColor=white) *(в планах)*
...
⭐ *Открыт к сотрудничеству и интересным проектам. Пишите!*
